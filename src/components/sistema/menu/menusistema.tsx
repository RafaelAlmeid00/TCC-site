...
export default function MenuSistema() {
    ...
    type RootState = {
        isNotificationVisible: boolean; // Adjust the type as per your actual state
        // Add other state properties here
    };

    const dispatch = useDispatch(); // Hook para despachar ação do Redux
    const isNotificationVisible = useSelector((state: RootState) => state.isNotificationVisible);
